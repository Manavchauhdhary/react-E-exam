    ...
    <div className="container py-5">
      <div className="row g-5">
        <div className="col-lg-3 col-md-6">
          ...
          <p className="mb-2"><i className="fa fa-map-marker-alt me-3" />123 Street, AHEMEDABAD, GUJARAT</p>
          <p className="mb-2"><i className="fa fa-phone-alt me-3" />+918849770459</p>
          <p className="mb-2"><i className="fa fa-envelope me-3" />info@examkiller.com</p>
        ...
        <div className="col-lg-3 col-md-6">
          ...
          <p>one of the best  web app for inline exam</p>
          <div className="position-relative mx-auto" style={{maxWidth: 400}}>
            {/* <input className="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email" /> */}
            <button type="button" className="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2"><Link to ="/Signup">SignUp</Link></button>
          </div>
        </div>
      </div>
    </div>
