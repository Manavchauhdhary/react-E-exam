            ...
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="mb-2"><i className="fa fa-envelope me-3"></i>testkillerofficial@gmail.com</p>
                    ...
                    {/* <div className="col-lg-3 col-md-6">
                        ...
                        <div className="position-relative mx-auto" id='a'>
                ...
                <div className="copyright">
                    <div className="row">
                        <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a className="border-bottom" href="https://htmlcodex.com">Manav chaudhary</a>
                        </div>
