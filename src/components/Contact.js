  ...
  <div className="container-xxl py-5">
    <div className="container">
      <div className="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: 600}}>
        ...
        <p>Hello ,WE are always free for student so if any query contact us.</p>
      </div>
            ...
            <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
              <div className="bg-light rounded p-3">
                <div className="d-flex align-items-center bg-white rounded p-3" style={{border: '1px dashed rgba(0, 185, 142, .3)'}}>
                  ...
                  <span>123 Street, AHEMEDABAD, GUJARAT</span>
                </div>
              </div>
            </div>
