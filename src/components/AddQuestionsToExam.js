...
export const AddQuestionsToExam = () => {
    ...
    const submitHandler = (e) => {
        ...
        e.preventDefault()
        axios.post(`http://localhost:3000/ques/${examId}/questions`, question).then(res => {
                                        ...
                                        <form className="mx-1 mx-md-4" onSubmit={submitHandler}>
                                            ...
                                            <div className="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div className="form-outline flex-fill mb-0">
                                                    <input type="text" name="questionName" id="questionName" onChange={(e) => { setqueName(e.target.value) }} className="form-control" />
